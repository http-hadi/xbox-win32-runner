...
WINBASEAPI BOOL WINAPI GlobalFree(HGLOBAL);
...
INT            WINAPI WSAStringToAddressW(struct sockaddr*, INT, LPWSAPROTOCOL_INFOW, LPINT, DWORD);
...
WINBASEAPI PSLIST_ENTRY WINAPI InterlockedPopEntrySList(PSLIST_HEADER, PSLIST_ENTRY);
...
WINBASEAPI UCHAR WINAPI GetNumaProcessorNode(UCHAR);
WINBASEAPI USHORT WINAPI GetNumaProcessorNodeEx(PPROCESSOR_NUMBER);
...
WINBASEAPI HANDLE WINAPI CreateFile2(LPCWSTR, DWORD, DWORD, DWORD, const CREATEFILE2_EXTENDED_PARAMETERS*);
...
WINBASEAPI PTP_WAIT WINAPI CreateThreadpoolWait(PTP_WAIT_CALLBACK, PVOID, PVOID);
WINBASEAPI VOID WINAPI SetThreadpoolWait(PTP_WAIT, HANDLE, PVOID);
...
WINBASEAPI PIMAGE_RUNTIME_FUNCTION_ENTRY WINAPI RtlLookupFunctionEntry(DWORD64, PDWORD, PIMAGE_RUNTIME_FUNCTION_ENTRY*);
...
WINBASEAPI VOID WINAPI RtlUnwindEx(PVOID, PVOID, PEXCEPTION_RECORD, PVOID, PCONTEXT, PEXCEPTION_HISTORY_TABLE);
WINBASEAPI PEXCEPTION_ROUTINE WINAPI RtlVirtualUnwind(DWORD, DWORD64, DWORD64, PIMAGE_RUNTIME_FUNCTION_ENTRY, PCONTEXT, PVOID*, PULONG_PTR, PEXCEPTION_ROUTINE*);
...
WINBASEAPI int WINAPI CompareStringEx(LPCWSTR, DWORD, LPCWSTR, int, LPCWSTR, int, LPNLSVERINFO, LPVOID, LPARAM);
...
WINBASEAPI int WINAPI LCMapStringEx(LPCWSTR, DWORD, LPCWSTR, int, LPWSTR, int, LPNLSVERINFO, LPVOID, LPARAM);
...
WINBASEAPI int WINAPI GetCurrencyFormatEx(LPCWSTR, DWORD, const CURRENCYFMTW*, LPCWSTR, LPWSTR, int);
WINBASEAPI int WINAPI GetNumberFormatEx(LPCWSTR, DWORD, const NUMBERFMTW*, LPCWSTR, LPWSTR, int);
...
WINBASEAPI BOOL WINAPI GetVersionExW(LPOSVERSIONINFOEXW);
...
WINBASEAPI BOOL WINAPI GetUserPreferredUILanguages(DWORD, PBOOL, PZZWSTR, PULONG);
...
// deref). Forward-declared struct is enough for the shim signature.
